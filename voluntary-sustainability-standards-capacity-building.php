    ...
    <div class="page-wrapper">
        ...
        <section class="project-details section-padding--bottom section-padding--top">
            <div class="container">
                ...
                <h3 class="project-details__title">Voluntary Sustainability Standards Capacity Building</h3><!-- /.project-details__title -->
                <div class="project-details__content">
                    <p>Capacity Building of Extension Workers in Tanzania’s Tea, Coffee, and Horticulture Sectors on Voluntary Sustainability Standards Tradecare prepared VSS guides and built the capacity of 30 extension workers to train farmers on VSS implementation.</p>
