        ...
        <section class="project-details section-padding--bottom section-padding--top">
            <div class="container">
                <div class="project-details__image">
                    <img src="assets/images/projects/Untitled design/2.png" alt="">
                ...
                <h3 class="project-details__title">Macadamia Value Chain Development Project    </h3><!-- /.project-details__title -->
                <div class="project-details__content">
                    <p>In collaboration with FMS and Jungle Nuts, Tradecare implemented a macadamia value chain development project in Embu County focused on improving productivity, quality, and aggregation of macadamia nuts. The project mobilized 2,000 farmers and organized them into clusters of 100 farmers each. It supported the clusters to link to markets, increase macadamia plantings, and aggregate and market nuts collectively. Project period: 2016–2020.</p>
