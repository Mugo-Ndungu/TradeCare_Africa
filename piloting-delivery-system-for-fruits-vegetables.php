        ...
        <section class="project-details section-padding--bottom section-padding--top">
            <div class="container">
                <div class="project-details__image">
                    <img src="assets/images/projects/Untitled design/1.png" alt="">
                ...
                <h3 class="project-details__title">Piloting Delivery System For Fruits & Vegetables</h3><!-- /.project-details__title -->
                <div class="project-details__content">
                    <p>Tradecare implemented a pilot that sought to deliver fresh fruits and vegetables from farmers that are certified GLOBALG.A.P. for export horticulture into a streamlined domestic market supply chain. The project period was 2020–2021, and his knowledge was used by the company to set up Tradecare Fish and Pantry Market.</p>
